function results = myRF_surrogate_CV10(X_all2,Y2)
rng(1)
...
for i=1:out
    ...
    %train time start
     tr_time=tic;
    AA_ext{i}=TreeBagger(ntree(optntree),train_ext_norm,labtrain_ext,'NumPredictorsToSample','all','Method','regression','PredictorSelection','curvature','Surrogate','on','OOBPredictorImportance','on');
